...
<section class="no-results not-found">
	...
	<div class="page-content">
		<?php if ( current_user_can( 'publish_posts' ) ) : ?>
			<p>
				<?php
				echo obsidian_allowed_tags( sprintf( _x( 'Ready to publish your first record? <a href="%1$s">Get started here</a>.', 'add post type link', 'obsidian' ),
		...
		<?php else : ?>
			<p>
				<?php esc_html_e( "There currently aren't any records available.", 'obsidian' ); ?>
			</p>
		<?php endif; ?>
	</div>
</section>
