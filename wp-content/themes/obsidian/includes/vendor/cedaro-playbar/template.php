...
<div class="playbar is-loading" itemscope itemtype="http://schema.org/MusicPlaylist">
	...
	<audio src="<?php echo esc_url( $tracks[0]['src'] ); ?>" controls preload="none" class="cue-audio" style="width: 100%; height: auto"></audio>
		...
		<ol class="cue-tracks-list">
			...
			<?php foreach ( $tracks as $track ) : ?>
				...
				<li class="cue-track" itemprop="track" itemscope itemtype="http://schema.org/MusicRecording">
					<?php do_action( 'playbar_track_before' ); ?>
					...
					<?php do_action( 'playbar_track_after' ); ?>
				</li>
