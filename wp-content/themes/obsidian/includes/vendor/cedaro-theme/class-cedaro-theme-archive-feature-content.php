...
class Cedaro_Theme_Archive_Feature_Content extends Cedaro_Theme_Archive_Feature {
	...
	public function add_support( $options = array() ) {
		if ( empty( $options ) ) {
			$options = array(
				'full-text'       => esc_html__( 'Full Text', 'obsidian' ),
				'summary'         => esc_html__( 'Summary', 'obsidian' ),
				'custom-excerpts' => esc_html__( 'Custom Excerpts', 'obsidian' ),
				'none'            => esc_html__( 'No Content', 'obsidian' ),
			);
		}
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( 'cedaro_archive_content_mode', array(
			'label'    => esc_html__( 'Archive Content', 'obsidian' ),
