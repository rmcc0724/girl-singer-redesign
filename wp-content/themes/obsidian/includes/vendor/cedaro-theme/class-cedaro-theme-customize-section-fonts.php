	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }}">
			<h3 class="accordion-section-title" tabindex="0">
				{{ data.title }}
				<span class="screen-reader-text"><?php esc_html_e( 'Press return or enter to open', 'obsidian' ); ?></span>
			</h3>
				...
				<li class="customize-section-description-container customize-info">
					<div class="customize-section-title">
						...
						<button type="button" class="customize-help-toggle cedaro-theme-fonts-section-toggle dashicons dashicons-editor-help" aria-expanded="false" data-target="#cedaro-theme-fonts-section-description">
							<span class="screen-reader-text"><?php esc_html_e( 'Help', 'obsidian' ); ?></span>
						</button>
						<button type="button" class="customize-screen-options-toggle cedaro-theme-fonts-section-toggle" aria-expanded="false" data-target="#cedaro-theme-fonts-section-options">
							<span class="screen-reader-text"><?php esc_html_e( 'Font Options', 'obsidian' ); ?></span>
						</button>
					</div>
					<div id="cedaro-theme-fonts-section-description" class="description customize-section-description cedaro-theme-fonts-section-content">
						<?php esc_html_e( 'Easily customize your fonts. Try to re-use fonts where possible to keep your website snappy.', 'obsidian' ); ?>
					</div>
					<div id="cedaro-theme-fonts-section-options" class="cedaro-theme-fonts-section-content">
						<p>
							<label for="cedaro-theme-fonts-option-typekit-id"><?php esc_html_e( 'Typekit Integration', 'obsidian' ); ?></label>
						</p>
						<p>
							<?php
							$text = sprintf(
								__( 'Enter a Kit ID to make custom fonts from Typekit available in each dropdown. %s', 'obsidian' ),
								sprintf( '<a href="https://audiotheme.com/support/kb/typekit/">%s</a>', esc_html__( 'Learn more.', 'obsidian' ) )
							);
